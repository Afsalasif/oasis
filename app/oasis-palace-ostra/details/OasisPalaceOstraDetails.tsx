              ...
              <div className="hidden md:flex items-center">
                <div className="relative w-8 h-8 mr-2">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="font-serif text-sm font-light text-[#c0aa83] italic tracking-wider">NS</div>
                  </div>
                </div>
        ...
        <div className="relative z-30 container mx-auto h-full flex flex-col justify-center px-4">
          ...
          >
            <div className="flex items-center">
              ...
              <span className="text-white">Premium Location, Dubai</span>
            </div>
            <div className="flex items-center">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div>
              <p className="text-gray-700 text-right">
                For inquiries: <span className="text-[#c0aa83] font-medium">+971 50 152 7835</span>
              </p>
              <p className="text-gray-700 text-right">
                Email: <span className="text-[#c0aa83] font-medium">noor.saray@yahoo.com</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <Tabs defaultValue="overview" value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="w-full justify-start bg-transparent h-auto border-b-0 p-0 overflow-x-auto flex-nowrap">
              {["overview", "villa-types", "payment-plan", "location", "gallery", "contact"].map((tab) => (
                <TabsTrigger
                  key={tab}
                  value={tab}
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            >
              <div className="lg:col-span-2">
                ...
                <p className="text-gray-700 mb-6 leading-relaxed">
                  Oasis Palace Ostra represents the pinnacle of luxury living in Dubai, offering an exclusive collection
                  of palace-inspired villas that blend timeless elegance with modern sophistication. As the first
                  palace-branded villas in Dubai, these residences set a new benchmark for opulent living.
                </p>

                <p className="text-gray-700 mb-6 leading-relaxed">
                  Each villa is meticulously crafted with attention to detail, featuring grand entrances, spacious
                  living areas, premium finishes, and smart home technology. The architectural design draws inspiration
                  from royal palaces, creating a sense of majesty and grandeur that is unparalleled in Dubai's real
                  estate landscape.
                </p>

                <p className="text-gray-700 mb-8 leading-relaxed">
                  Residents of Oasis Palace Ostra will enjoy not only the exceptional quality of their homes but also
                  the exclusivity of being part of a limited collection of luxury villas in a prime location. With a
                  range of villa types to choose from, each offering unique features and layouts, there is a perfect
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h3 className="text-lg font-medium text-gray-900 mb-4">Project Highlights</h3>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-900 font-medium">Luxury Villas</span>
                    </div>
                    <Separator />

                    <div className="flex justify-between">
                      <span className="text-gray-600">Location</span>
                      <span className="text-gray-900 font-medium">Premium Dubai Location</span>
                    </div>
                    <Separator />

                    <div className="flex justify-between">
                      <span className="text-gray-600">Handover</span>
                      <span className="text-gray-900 font-medium">September 2029</span>
                    </div>
                    <Separator />
                    ...
                    <div className="flex justify-between">
                      ...
                      <Badge className="bg-green-100 text-green-800 hover:bg-green-100">Launching Soon</Badge>
                    </div>
                  </div>
                </div>

                <div className="bg-[#c0aa83]/10 p-6 rounded-lg">
                  <h3 className="text-lg font-medium text-gray-900 mb-4">Limited Time Opportunity</h3>
                  <p className="text-gray-700 mb-4">
                    Booking starts Monday with a limited number of units available. Secure your palace-inspired villa
                    today.
                  </p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                <div className="lg:col-span-1 space-y-4">
                  {villaTypes.map((villa) => (
                    <div
                      key={villa.id}
                      className={`p-4 rounded-lg cursor-pointer transition-all duration-300 ${selectedVilla.id === villa.id
                    ...
                    >
                      <h3
                        className={`font-medium mb-2 ${selectedVilla.id === villa.id ? "text-[#c0aa83]" : "text-gray-900"
                          }`}
                      >
                        {villa.title}
                      </h3>
          ...
          <TabsContent value="payment-plan" className="mt-0">
            <motion.div initial="hidden" animate={isVisible ? "visible" : "hidden"} variants={fadeIn}>
              <div className="max-w-4xl mx-auto">
                <h2 className="text-2xl md:text-3xl font-serif text-gray-900 mb-6">Payment Plan</h2>
                <p className="text-gray-700 mb-12">
                  Oasis Palace Ostra offers a straightforward 80:20 payment plan, designed to make your investment
                ...
                <div className="bg-white rounded-lg shadow-lg overflow-hidden mb-12">
                  <div className="bg-[#c0aa83] p-6 text-white">
                    <div className="flex justify-between items-center">
                      <h3 className="text-xl font-medium">80:20 Payment Plan</h3>
                      <div className="flex items-center">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <h4 className="font-medium text-gray-900 mb-4">Payment Plan Benefits</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-start">
                      <Check className="h-5 w-5 text-[#c0aa83] mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-700">Straightforward structure with clear milestones</span>
                    </div>
                    <div className="flex items-start">
                      <Check className="h-5 w-5 text-[#c0aa83] mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-700">Majority of payment during construction period</span>
                    </div>
                    <div className="flex items-start">
                      <Check className="h-5 w-5 text-[#c0aa83] mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-700">Manageable final payment at handover</span>
                    </div>
                    <div className="flex items-start">
                      <Check className="h-5 w-5 text-[#c0aa83] mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-700">No post-handover payments required</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <TabsContent value="location" className="mt-0">
            <motion.div initial="hidden" animate={isVisible ? "visible" : "hidden"} variants={fadeIn}>
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                <div className="lg:col-span-2">
                  <h2 className="text-2xl md:text-3xl font-serif text-gray-900 mb-6">Prime Location</h2>

                  <p className="text-gray-700 mb-6">
                    Oasis Palace Ostra is strategically located in one of Dubai's most prestigious neighborhoods,
                    offering residents the perfect balance of privacy and connectivity.
                  </p>

                  <p className="text-gray-700 mb-8">
                    The development enjoys proximity to key landmarks, educational institutions, healthcare facilities,
                    and leisure destinations, making it an ideal location for families and individuals seeking a premium
                    lifestyle.
                  </p>
                  {/* 
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                    ...
                    <div className="p-6">
                      <h3 className="text-lg font-medium text-gray-900 mb-2">Schedule a Site Visit</h3>
          ...
          <TabsContent value="gallery" className="mt-0">
            <motion.div initial="hidden" animate={isVisible ? "visible" : "hidden"} variants={fadeIn}>
              ...
              <p className="text-gray-700 mb-8">
                Explore the stunning visuals of Oasis Palace Ostra through our curated gallery of renderings and design
                concepts.
              </p>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                {['/hero.png', "/about.png", "/lux.png", "/hero2.png", "/g1.png", "/g2.png", "/g3.png", "/g4.png",].map((ah, index) => (
                  <div
                    key={index}
              ...
              <div className="bg-gray-50 p-8 rounded-lg text-center">
                <h3 className="text-xl font-medium text-gray-900 mb-4">Experience Oasis Palace Ostra in Person</h3>
          ...
          <TabsContent value="contact" className="mt-0">
            <motion.div initial="hidden" animate={isVisible ? "visible" : "hidden"} variants={fadeIn}>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div>
                  <h2 className="text-2xl md:text-3xl font-serif text-gray-900 mb-6">Contact Noor Saray</h2>

                  <p className="text-gray-700 mb-8">
                    Our dedicated sales team at Noor Saray Real Estate is ready to assist you with any inquiries about
                    Oasis Palace Ostra. Reach out to us through any of the following channels.
                  </p>

                  <div className="space-y-6 mb-8">
                    <div className="flex items-start">
                      <div className="mr-4 mt-1 bg-[#c0aa83]/10 p-2 rounded-full">
                        <div className="w-5 h-5 flex items-center justify-center text-[#c0aa83] font-serif">T</div>
                      </div>
                      <div>
                        <h3 className="font-medium text-gray-900 mb-1">Call Us</h3>
                        <p className="text-gray-600">+971 50 152 7835</p>
                        <p className="text-gray-500 text-sm">Available 7 days a week, 9am - 8pm</p>
                      </div>
                    </div>

                    <div className="flex items-start">
                      <div className="mr-4 mt-1 bg-[#c0aa83]/10 p-2 rounded-full">
                        <div className="w-5 h-5 flex items-center justify-center text-[#c0aa83] font-serif">E</div>
                      </div>
                      <div>
                        <h3 className="font-medium text-gray-900 mb-1">Email Us</h3>
                        <p className="text-gray-600">noor.saray@yahoo.com</p>
                    ...
                    <div className="flex items-start">
                      <div className="mr-4 mt-1 bg-[#c0aa83]/10 p-2 rounded-full">
                        <div className="w-5 h-5 flex items-center justify-center text-[#c0aa83] font-serif">V</div>
                      </div>
                      <div>
                        <h3 className="font-medium text-gray-900 mb-1">Visit Our Sales Center</h3>
                        <p className="text-gray-600">Noor Saray Real Estate,Clover Bay ,Buissness bay</p>
                        <p className="text-gray-500 text-sm">Open daily from 10am - 6pm</p>
                      </div>
                    </div>
                  </div>

                  <div className="bg-gray-50 p-6 rounded-lg">
                    <h3 className="text-lg font-medium text-gray-900 mb-4">Booking Opens Monday</h3>
                    <p className="text-gray-700 mb-4">
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                <div>
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <p className="text-gray-700 font-medium">Exclusively Presented By</p>
                      <h3 className="text-xl font-serif text-[#c0aa83]">Noor Saray Real Estate</h3>
                    </div>
                  </div>
                  <p className="text-gray-600 max-w-md">
                    With limited units available and booking starting Monday, secure your palace-inspired villa today.
                  </p>
                </div>
