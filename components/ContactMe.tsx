...
export default function ContactMe({ isOpen, onClose }: ContactModalProps) {
          ...
          <div className="p-6">
            {isSubmitted ? (
              <div className="text-center">
                ...
                <p className="text-gray-600 mt-2">We've received your request and will contact you soon.</p>
              ...
              <>
                <p className="text-gray-600 mb-6">
                  Schedule a consultation with our experts. Fill out the form below, and we'll get in touch with you.
                </p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-gray-700">Are you in Dubai?</label>
                    <select
                      name="inDubai"
                      value={formData.inDubai}
                      onChange={handleChange}
                      className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#c0aa83]"
                      required
                      disabled={isSubmitting}
